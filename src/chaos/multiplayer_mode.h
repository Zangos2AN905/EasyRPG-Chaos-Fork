...
inline const ModeProperties& GetModeProperties(MultiplayerMode mode) {
	static const ModeProperties props[] = {
		{ "Normal",     "Normal non-team mode. Unlimited players.",                      0, false, false, false, false },
		{ "Team Party", "Team up! Switches and variables sync. Max 4 players.",          4, true,  true,  false, false },
		{ "Chaotix",    "Team mode, but players must stay close together. Max 4.",       4, true,  true,  true,  false },
		{ "Pandora",    "Normal mode, but switches and variables sync.",                 0, true,  true,  false, false },
		{ "God Mode",   "One player controls the game. Others play normally.",           0, false, false, false, true  },
	};
